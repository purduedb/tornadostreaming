...
public class Extractor {
	...
	public static ArrayList<ArrayList<Double>> read(int num) throws Exception
	{
	...
	public static ArrayList<ArrayList<String>> readKeys(int linenum) throws Exception {
		BufferedReader br = new BufferedReader(new FileReader("resources/test.txt"));
		String line;
		int currnum=0;
		while((line=br.readLine())!=null){
			if(currnum == linenum){ //linenum is a 0 based index
				extractExprKey(line);
				Thread.sleep(10);
				break;
			}
	...
	public static void main(String[] args) throws Exception {
		...
		//       extr.z.add(extr.x);
		//z.add(x);
		ArrayList<ArrayList<Double>> newarray = read(0);
		System.out.println();
