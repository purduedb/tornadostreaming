...
public class AtlasParserSpout extends FileSpout implements BaseTornadoQuerySpout{
	...
	static Integer Kindex = new Integer(0);
	static Integer thepointer = new Integer(0);
	static Integer arraylistpointer = new Integer(0); //added
	...
	public Query buildQuery(String line) {
		try {
			...
			if(arraylistpointer > super.listArray.size())
			{
			...
			try {				
				...
				ArrayList<Double> myarrlist = super.listArray.get(arraylistpointer);
				...
				{
					System.out.println("ListArraySize: " + super.listArray.size());
				} //buildQuery(String line)
			
			
			if (mylat < SpatioTextualConstants.minLat || mylat > SpatioTextualConstants.maxLat || mylon < SpatioTextualConstants.minLong || mylon > SpatioTextualConstants.maxLong
			...
			ArrayList<String> textList1 = super.KeyArray.get(Kindex);
			Kindex++; 
			
			if(Kindex > super.KeyArray.size()){
