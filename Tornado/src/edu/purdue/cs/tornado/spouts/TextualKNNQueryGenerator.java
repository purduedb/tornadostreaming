...
public class TextualKNNQueryGenerator extends BaseRichSpout {
	...
	public void nextTuple() {
		...
		if (i < SpatioTextualConstants.numQueries) { // i will be the query
			...
			Date date = new Date();
			this.collector.emit(new Values(SpatioTextualConstants.queryTextualKNN,""+i, xCoord, yCoord, k,textContent,date.getTime(),dataSrcId,SpatioTextualConstants.addCommand));
