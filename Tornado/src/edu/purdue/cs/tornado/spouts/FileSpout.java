...
public class FileSpout extends BaseRichSpout implements BaseTornadoDataSpout, BaseTornadoQuerySpout {
	...
	public ArrayList<ArrayList<Double>> listArray;
	public ArrayList<ArrayList<String>> KeyArray;
	...
	public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
		listArray = new ArrayList<ArrayList<Double>>();
		KeyArray = new ArrayList<ArrayList<String>>();
		//this.conf = conf;
...
//			pt = new Path(filePath);
		...
		try {
			...
			//System.out.println("The listarray is : " + listArray);
		} catch (Exception e1) {
		...
		try {
			...
			//System.out.println("The KeyArray is: "+KeyArray);
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
