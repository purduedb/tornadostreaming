...
//	}
	...
	public static Rectangle spatialIntersect(Rectangle rect1,Rectangle rect2){
		return new Rectangle(new Point(Math.max(rect1.getMin().getX(), rect2.getMin().getX()),
				Math.max(rect1.getMin().getY(), rect2.getMin().getY())),new Point(Math.min(rect1.getMax().getX(), rect2.getMax().getX()),
						Math.min(rect1.getMax().getY(), rect2.getMax().getY())));
	}

	public static Rectangle union(Rectangle rect1,Rectangle rect2){
		return new Rectangle(new Point(Math.min(rect1.getMin().getX(), rect2.getMin().getX()),
				Math.min(rect1.getMin().getY(), rect2.getMin().getY())),new Point(Math.max(rect1.getMax().getX(), rect2.getMax().getX()),
						Math.max(rect1.getMax().getY(), rect2.getMax().getY())));
	}
	
	public static Rectangle expand(Rectangle rect1,Double area){
		return new Rectangle(
				new Point(Math.max(rect1.getMin().getX()-area,0),
						Math.max(rect1.getMin().getY()-area,0)),
				new Point(Math.min(rect1.getMax().getX()+area,SpatioTextualConstants.xMaxRange),
						Math.min(rect1.getMax().getY()+area,SpatioTextualConstants.yMaxRange))
				);
	}
	/**
