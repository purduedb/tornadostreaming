...
public class DynamicSpatialIndexBolt extends BaseRichBolt {
	...
	// ******************Grid parameters ********************************
	GlobalDynamicKDTree globalGridIndex;
	 ...
	 * @param id
	 */
	 public DynamicSpatialIndexBolt(String id) {
		this.id = id;
	...
	public void prepare(Map stormConf, TopologyContext context, OutputCollector collector) {
		...
		globalGridIndex = new GlobalDynamicKDTree(numberOfEvaluatorTasks, evaluatorBoltTasks);
