...
public class QuadTreeIndexCell {
	...
	public QuadTreeIndexCell[] children;

	public QuadTreeIndexCell parent;
	...
	public QuadTreeIndexCell(Rectangle bounds, Boolean spatialOnlyFlag, Integer level) {
		storedObjects = null;
		allDataTextInCell = null;
		allQueryTextInCell = null;
		storedQueries = null;
	...
	public QuadTreeIndexCell(Rectangle bounds, Boolean spatialOnlyFlag, Integer level, IndexCellCoordinates globalCoordinates) {
		storedObjects = null;
		allDataTextInCell = null;
		allQueryTextInCell = null;
		storedQueries = null;
	...
	public QuadTreeIndexCell addDataObjectRecusrive(DataObject dataObject) {
		if (storedObjects == null)
			storedObjects = new HashMap<Integer, DataObject>();
		if (allDataTextInCell == null)
			allDataTextInCell = new HashMap<String, Integer>();
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof QuadTreeIndexCell))
			return false;
		QuadTreeIndexCell c = (QuadTreeIndexCell) o;
