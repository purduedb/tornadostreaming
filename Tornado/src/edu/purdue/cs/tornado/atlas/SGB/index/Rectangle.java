...
public class Rectangle {
  ...
  public float bound[];/* xmin, ymin, zmin, xmax, ymax, zmax (for 3 dimensional RTree) */
  ...
  public Rectangle(int DIMS_NUMB)
  {
	  float bound[]=new float[DIMS_NUMB*2];
	  
	  int i=0;
	  for(;i<DIMS_NUMB;i++)
	  {
		  bound[i]=Float.MAX_VALUE;
	  }
  ...
  public Rectangle(float ...coordinates) {
	  ...
	  bound=new float[coordinates.length];
	  bound=coordinates.clone();
