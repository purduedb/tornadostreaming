...
public class POIsStaticDataSource extends AbstractStaticDataSource{
	private Integer count;
	private Integer maxCount;
	private ArrayList<DataObject> pois;
	
	public POIsStaticDataSource(Rectangle bounds,
	...
	public void  prepareData() {
		...
		count = 0;
		 String filePath="/home/ahmed/Downloads/partitionedPOIsusa/";
		try {
			FileInputStream fstream = new FileInputStream(filePath+selfTaskIdIndex+".csv");
			...
			while ((strLine = br.readLine()) != null&&count<=20000) {
	...
	public Boolean hasNext() {
		if (count < pois.size()&&count<=20000)
			return true;
		else
			return false;
	}
